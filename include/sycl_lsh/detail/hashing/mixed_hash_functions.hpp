...
#ifndef SYCL_LSH_HASHING_MIXED_HASH_FUNCTIONS_HPP
#define SYCL_LSH_HASHING_MIXED_HASH_FUNCTIONS_HPP
#pragma once
 ...
 * @details Mixes random-projections and entropy-based hash functions.
 */
...
#endif  // SYCL_LSH_HASHING_MIXED_HASH_FUNCTIONS_HPP
