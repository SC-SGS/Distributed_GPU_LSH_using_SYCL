 ...
 * @date 2020-today
 *
 * @brief Defines a template class for specializing the calculating of the hash value for a specific @ref sycl_lsh::hash_function_type.
 */
...
/**
 * @brief Template class to specialize the calculation of the hash value for a specific @ref sycl_lsh::hash_function_type.
