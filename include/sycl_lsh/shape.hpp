...
#ifndef SYCL_LSH_SHAPE_HPP
#define SYCL_LSH_SHAPE_HPP
#pragma once
...
struct [[nodiscard]] shape {
     ...
     * @details Explicit to prevent conversions from `{ 2, 2 }` to a @ref sycl_lsh::shape.
     ...
     * @details Explicit to prevent conversions from `{ 2, 2, 2 }` to a @ref sycl_lsh::shape.
     * @param[in] x_p the shape in x-dimension
     * @param[in] y_p the shape in y-dimension
    ...
    /**
     * @brief Swap the @ref sycl_lsh::shape dimensions of `*this` with the ones of @p other.
...
/**
 * @brief Output the @ref sycl_lsh::shape @p s to the given output-stream @p out.
 * @param[in,out] out the output-stream to write the shape to
 * @param[in] s the @ref sycl_lsh::shape
 * @return the output-stream
 */
std::ostream &operator<<(std::ostream &out, const shape &s);

/**
 * @brief Use the input-stream @p in to initialize the @ref sycl_lsh::shape @p s.
...
/**
 * @brief Swap the @ref sycl_lsh::shape dimensions of @p lhs with the ones of @p rhs.
 * @param[in,out] lhs the first @ref sycl_lsh::shape
 * @param[in,out] rhs the second @ref sycl_lsh::shape
 */
void swap(shape &lhs, shape &rhs) noexcept;

/**
 * @brief Check whether the shapes @p lhs and @p rhs are equal.
 * @param[in] lhs the first @ref sycl_lsh::shape
 * @param[in] rhs the second @ref sycl_lsh::shape
...
template <>
struct fmt::formatter<sycl_lsh::shape> : fmt::ostream_formatter { };

/// @endcond

#endif  // SYCL_LSH_SHAPE_HPP
