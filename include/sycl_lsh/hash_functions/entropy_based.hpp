...
class entropy_based {
  public:
     ...
     */
    entropy_based(const locality_sensitive_hashing_options &opt, const detail::device_ptr<real_type> &data, data_attributes attributes, sycl::queue &queue, const mpi::communicator &comm, const mpi::logger &logger);
